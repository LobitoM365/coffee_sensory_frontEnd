...
let contentRangeColor = document.getElementById("contentRangeColor");
let divRangeColor = document.getElementById("divRangeColor");

function resizecontentRangeColor(){
    contentRangeColor.style.height = divRangeColor.scrollHeight + "px"
}

resizecontentRangeColor()

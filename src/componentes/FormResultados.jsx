                                ...
                                <div className="div-body-form">
                                    <div className="div-contenido-info-analisis">
                                        <div className="info-analisis info-catador">
                                            <h3 className="title-info"><span className="span-title-info">Información sobre el catador</span>  <div className="title-svg"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enableBackground="new 0 0 256 256" >
                                                <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
                                        ...
                                        <div className="info-analisis">
                                            <h3 className="title-info"><span className="span-title-info">Información sobre el análisis</span><div className="title-svg"><svg version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enableBackground="new 0 0 256 256" >
                                                <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
                                        ...
                                        <div className="info-analisis">
                                            <h3 className="title-info"><span className="span-title-info">Información de la ubicación</span><div className="title-svg"><svg version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enableBackground="new 0 0 256 256" >
                                                <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
                                        ...
                                        <div className="info-analisis">
                                            <h3 className="title-info"><span className="span-title-info">Información sobre la muestra</span> <div className="title-svg ">

    ...
    return (
        <div className="main-container">
            ...
            <div className="bg-img">
                ...
                <svg id="visualBottom" viewBox="0 0 1000 600" width="900" height="600"  version="1.1"><path d="M0 483L30 478.8C60 474.7 120 466.3 180 469.8C240 473.3 300 488.7 360 477.2C420 465.7 480 427.3 540 417.2C600 407 660 425 720 426.2C780 427.3 840 411.7 870 403.8L900 396" fill="none" stroke-linecap="round" stroke-linejoin="miter" stroke="#009473" stroke-width="40"></path></svg> */}
                    ...
                    <form className="login-form" onSubmit={handleSubmit}>
                        ...
                        <div className="container-inputs">
                            ...
                            <div className="eyes-container">
                                {!eyes ? <div className="" onClick={() => { setEyes(!eyes) }}><svg version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enableBackground="new 0 0 256 256">

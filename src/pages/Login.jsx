        ...
        try {
            ...
            if (response.data.errors) {
                ...
                setdataAlert({
                    status: "true",
                    description: response.data.message,
                    "tittle": "Proceso realizado con éxito!",
                });
            } else {
                serLoader(false);
                    ...
                    <form className="login-form bots-form" id="loginForm" onSubmit={handleSubmit}>
                        ...
                        <div className="container-inputs">
                            ...
                            <div className="eyes-container">
                                {!eyes ? <div className="svg-eyes-two" onClick={() => { setEyes(!eyes) }}><svg version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enableBackground="new 0 0 256 256">
                                ...
                                </div> : <svg onClick={() => { setEyes(!eyes) }} className="eyes-closed svg-eyes" version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enableBackground="new 0 0 256 256">
                                    <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>

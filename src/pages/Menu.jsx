                ...
                <ul id="ulContentLi">
                    ...
                    <li className="hamburguer-centered">
                        ...
                        <ul>
                            ...
                            <Link title="Formatos" to={"/dashboard/formatos/registros"} onClick={() => { selectedLi("/dashboard/formatos/registros") }} className={`link-memu-horizontal  ${liSelected == "/dashboard/formatos/registros" ? "selected-li" : ""}`}>
                                <li className="hamburguer-centered">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="icon-li-nav-horizontal" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enable-background="new 0 0 256 256" xml:space="preserve">
                                        <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
